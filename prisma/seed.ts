...
async function main() {
  ...
  const books = [
    ...
    },
    {
      ...
      fileUrl: "https://s3.amazonaws.com/epubjs/books/alice/OPS/package.opf", // Placeholder
    ...
    },
    {
      ...
      fileUrl: "https://s3.amazonaws.com/epubjs/books/moby-dick/OPS/package.opf", // Placeholder
      tags: ["IT", "RU", "Учебник"],
      category: "Наука"
    },
    {
  ...
  console.log('Наполнение успешно завершено!');
}
